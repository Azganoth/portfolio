          ...
          >
            ...
            <div class="w-full lg:max-w-md lg:flex-1">
              {#if lastProject.previews.length > 0}
                ...
                <button
                  type="button"
                  class="group relative aspect-4/3 max-h-90 w-full overflow-hidden rounded-2xl border border-white/15 bg-muted/40 shadow-2xl transition-colors hover:border-primary/60 focus-visible:ring-4 focus-visible:ring-primary"
                  onclick={() => {
                    if (lastProject) {
