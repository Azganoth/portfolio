...
export const TAG_META: Record<string, { color: string; icon: string }> = {
  ...
  "Next.js": { color: "#FFFFFF", icon: "simple-icons:nextdotjs" },
  SASS: { color: "#CC6699", icon: "simple-icons:sass" },
  TailwindCSS: { color: "#06B6D4", icon: "simple-icons:tailwindcss" },
  "Tailwind CSS": { color: "#06B6D4", icon: "simple-icons:tailwindcss" },
  ...
  Prisma: { color: "#D2C8B7", icon: "simple-icons:prisma" },
  ...
  "GitHub Actions": { color: "#2088FF", icon: "simple-icons:githubactions" },
  ...
  fallback: { color: "#FFFFFF", icon: "fa7-solid:circle" },
};
