  ...
  return (
    <a
      class={simpleCX(
        ...
        type === "nav" &&
          "before:px-0.5 before:font-decorative before:text-gray before:opacity-0 before:content-['<'] after:font-decorative after:opacity-0 after:content-[--underscore] hover:text-orchid hover:before:opacity-100 hover:after:animate-blink hover:after:opacity-100 max-md:text-l",
        className,
      )}
      href={href}
